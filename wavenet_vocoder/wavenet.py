...
class WaveNet(nn.Module):
    ...
    def __init__(self, out_channels=256, layers=20, stacks=2,
        ...
        if scalar_input:
            self.first_conv = Conv1d1x1(1, residual_channels, weight_normalization=weight_normalization)
        else:
            self.first_conv = Conv1d1x1(out_channels, residual_channels, weight_normalization=weight_normalization)
